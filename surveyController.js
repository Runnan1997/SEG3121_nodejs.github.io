...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var dPage = readData("color");
        var name = readData("fruit");
        var sex = readData("sex")
        var adjustP = readData("animal");
        var age = readData("age");
        var comments = readData("comments");
        res.render('showResults', {results: [dPage, name, sex, age, adjustP,comments]});
        console.log([dPage, name, sex, age, adjustP, comments]);
    });
